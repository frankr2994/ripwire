#pragma once
  ...
  #include <format>
    ...
    #endif
    inline int __builtin_ctzll( unsigned long long val ) noexcept
    {
        unsigned long idx = 0;
        _BitScanForward64( &idx, val );
        return static_cast<int>( idx );
    }
    inline int __builtin_ctz( unsigned int val ) noexcept
    {
        unsigned long idx = 0;
        _BitScanForward( &idx, static_cast<unsigned long>( val ) );
        return static_cast<int>( idx );
    }
  #endif
