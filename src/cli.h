...
struct Config
{
    ...
    bool             indexCoverage = false; // additive JSON index inventory
...
inline void printUsage( std::FILE* out ) noexcept
{
    ...
    std::fprintf( out,
        ...
        "    --index-coverage           machine-readable indexed paths and skipped-path reasons (additive)\n"
...
inline constexpr BoolFlag kBoolFlags[] =
{
    ...
    { "--index-coverage",     &Config::indexCoverage      },
